...
This guide should not directly redistribute large proprietary Huawei firmware packages unless you have the right to do so. Use file names, checksums, and original source references instead.
